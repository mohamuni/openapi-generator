...
try:
    from petstore_api.model import biology_hominid
except ImportError:
    biology_hominid = sys.modules[
        'petstore_api.model.biology_hominid']
try:
    from petstore_api.model import biology_mammal
except ImportError:
    biology_mammal = sys.modules[
        'petstore_api.model.biology_mammal']
try:
    from petstore_api.model import biology_primate
except ImportError:
    biology_primate = sys.modules[
        'petstore_api.model.biology_primate']
try:
    from petstore_api.model import biology_reptile
except ImportError:
    biology_reptile = sys.modules[
        'petstore_api.model.biology_reptile']


class BiologyChordate(ModelNormal):
    ...
    def __init__(self, class_name, _check_type=True, _spec_property_naming=False, _path_to_item=(), _configuration=None, _visited_composed_classes=(), **kwargs):  # noqa: E501
        """biology_chordate.BiologyChordate - a model defined in OpenAPI
